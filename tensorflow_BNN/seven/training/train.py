...
def main(_):
  ...
  if FLAGS.start_checkpoint:
    ...
    if FLAGS.set_prefilter:
      models.init_variables_from_checkpoint(None, FLAGS.set_prefilter, 'freqconv/')
  elif FLAGS.init_checkpoint:
    models.init_variables_from_checkpoint(sess, FLAGS.init_checkpoint)
  elif FLAGS.set_prefilter:
    models.init_variables_from_checkpoint(sess, FLAGS.set_prefilter, 'freqconv/')
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--data_dir',
      type=str,
      default='/home/atsg/PycharmProjects/gvh205_Lattice_BNN/Lattice_BNN/KeyPhrase_Package/speech_commands_v0.01',
      help="""\
  ...
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default='/home/atsg/PycharmProjects/gvh205_Lattice_BNN/Lattice_BNN/KeyPhrase_Package/seven/training/checkpoint',
      help='Where to save summary logs for TensorBoard.')
  parser.add_argument(
      '--wanted_words',
      type=str,
      default='seven',
      help='Words to use (others will be added to an unknown label), yes,no,up,down,left,right,on,off,stop,go',)
  parser.add_argument(
      '--train_dir',
      type=str,
      default='/home/atsg/PycharmProjects/gvh205_Lattice_BNN/Lattice_BNN/KeyPhrase_Package/seven/training/checkpoint',
