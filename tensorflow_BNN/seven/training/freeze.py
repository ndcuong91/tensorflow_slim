...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--downsample', type=int, default=1, help='Down sampling ratio',)
  parser.add_argument(
      '--no_prefilter_bias', dest='prefilter_bias', action='store_false', help='Do not add bias on prefilter')
  parser.add_argument(
      '--use_down_avgfilt', type=bool, default=False, help='Whether to use average filter in prefilter downsampling')
  parser.add_argument(
      '--norm_binw',
      dest='norm_binw',
      action='store_true',
