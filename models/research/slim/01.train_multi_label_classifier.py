...
tf.app.flags.DEFINE_integer(
    'save_summaries_secs', save_ckpt_every_seconds,
    'The frequency with which summaries are saved, in seconds.')

tf.app.flags.DEFINE_integer(
    'save_interval_secs', save_ckpt_every_seconds,
...
def main(_):
  ...
  with tf.Graph().as_default():
    ...
    with tf.device(deploy_config.inputs_device()):
      ...
      num_batches = math.ceil(provider.num_samples() / float(FLAGS.batch_size))
      num_steps = FLAGS.max_number_of_steps * int(num_batches)
